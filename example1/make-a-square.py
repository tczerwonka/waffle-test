...
async def main():
    for i in range(4): #this is a loop. The orange number is how many times you want the loop to happen. The code you want repeted has to be indented
        ...
        #Now lets reverse
    for i in range(4):#another loop
            await stopped_turn(-90) #adding a negitive infront of a stopped_turn command will make it turn left
            await run_motors(-25) #a negitive parameter for run_motors command will make it go backward
